...
const Footer = () => {
    return (
      ...
      <h1 style={{ color: "green", 
                   textAlign: "center", 
                   marginTop: "-50px", fontSize: '40px', fontWeight: 'bold'}}>
      ...
      <Container>
        <Row>
          ...
          <Column>
            ...
            <FooterLink href="#">Operation</FooterLink>
            <FooterLink href="#">Carrers</FooterLink>
            <FooterLink href="#">HalthCare</FooterLink>
          </Column>
          <Column>
            <Heading>Contact Us</Heading>
            <FooterLink href="#">Jahid Hasan</FooterLink>
